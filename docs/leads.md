...
- Informações de evento, URL, consentimento, UTMs e gclid ficam registradas nas notas do lead.
- Cada envio recebe uma chave única para evitar duplicidade em novas tentativas do navegador.

O WhatsApp é apresentado somente depois da confirmação. Assim, fechar ou abandonar a conversa não elimina o lead já salvo.
