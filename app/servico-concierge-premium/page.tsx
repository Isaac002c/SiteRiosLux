...
export const metadata: Metadata = {
  ...
  description: 'Consultoria e concierge para experiências, hospitalidade e eventos no Rio de Janeiro.',
...
export default function Page() {
  return (
    ...
    { title: 'Consultoria', description: 'Organizamos alternativas coerentes e apoiamos decisões de acordo com o briefing.' },
    { title: 'Coordenação', description: 'Conectamos as escolhas à logística e aos parceiros envolvidos na experiência.' },
      ]}
      scope={['Briefing', 'Consultoria', 'Reservas', 'Agenda', 'Recepção', 'Logística', 'Hospitalidade', 'Coordenação', 'Acompanhamento']}
